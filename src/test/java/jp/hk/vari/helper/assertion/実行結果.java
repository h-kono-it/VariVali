package jp.hk.vari.helper.assertion;
...
public class 実行結果<T> {
  ...
  public void はtrueです(Supplier<String> messageSupplier) {
    ...
    assertTrue(false, messageSupplier);
  }

  public void はfalseです() {
    if (this.actual instanceof Boolean b) {
      assertFalse(b, "実行結果はtrueでした。");
      return;
    }
  ...
  public void はfalseです(Supplier<String> messageSupplier) {
    ...
    assertFalse(true, messageSupplier);
  }
